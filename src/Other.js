...
const Other = () => {
  ...
  React.useEffect(() => {
    const sectionHero = document.querySelector(".section-other");
  ...
  const [otherdata] = React.useState(Data2);
    ...
    <> 
      ...
      <section className="section section-other">
        <div className="container">
          <h2 className="common-heading">Other Products&nbsp; <i className="fa-solid fa-desktop"></i></h2>
          <p className='category-para'>Emulator In offers a diverse range of gaming peripherals - from responsive keyboards to precision gaming mouse, enhancing your gaming setup effortlessly.</p>
        </div>
        <div className="container grid grid-three-columns product-img">
          {otherdata.map((curele) => {
            return (
